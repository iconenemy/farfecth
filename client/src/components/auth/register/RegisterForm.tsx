...
const RegisterForm = () => {
  ...
  return (
    <form className="w-full" onSubmit={formik.handleSubmit}>
      ...
      <div className="mb-6">
        <p className="text-xs">
          Your personal information will be managed by Icon Limited, with
          ...
          the U.K., Europe and USA). Icon uses your personal information to
          offer an enhanced customer service tailored to your preferences and
          may share your personal information with Icon group companies and
          third parties who support Icon in providing products and services
          to you on Icon’s behalf. By continuing, you confirm you have read
